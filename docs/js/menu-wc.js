...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">TCS</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/TcsModule.html" data-type="entity-link">TcsModule</a>
                            </li>
                            <li class="link">
                                <a href="classes/TcsModuleManager.html" data-type="entity-link">TcsModuleManager</a>
                            </li>
                            <li class="link">
                                <a href="classes/TcsThread.html" data-type="entity-link">TcsThread</a>
                            </li>
                            <li class="link">
                                <a href="classes/TcsThreadsManager.html" data-type="entity-link">TcsThreadsManager</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
